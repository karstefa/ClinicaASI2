...
import sv.com.asi.controladores.EstadoOrdenFacade;
...
public class EstadoOrdenController implements Serializable {
    ...
    private EstadoOrden current;
    private DataModel items = null;
    @EJB
    private sv.com.asi.controladores.EstadoOrdenFacade ejbFacade;
    ...
    public String prepareView() {
        current = (EstadoOrden) getItems().getRowData();
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/lenguajes").getString("EstadoOrdenCreated"));
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/lenguajes").getString("EstadoOrdenUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/lenguajes").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/lenguajes").getString("EstadoOrdenDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/lenguajes").getString("PersistenceErrorOccured"));
        }
    }
    ...
    public static class EstadoOrdenControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof EstadoOrden) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + EstadoOrden.class.getName());
            }
        }
